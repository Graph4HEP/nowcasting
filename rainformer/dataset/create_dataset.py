'''
Modified and adapted from https://github.com/HansBambel/SmaAt-UNet/create_datasets.py
'''
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='creat dataset')
    parser.add_argument('--input_length', type=int, default=12)
    parser.add_argument('--image_ahead', type=int, default=6)
    parser.add_argument('--rain_amount_thresh', type=float, default=0.5)
    args = parser.parse_args()
    create_dataset(input_length=args.input_length, image_ahead=args.image_ahead, rain_amount_thresh=args.rain_amount_thresh)
